...
<html lang="en">
  <head>
    ...
    <title>Profile - AthifaDaycare</title>
            ...
            <div class="row">
                <div class="col-lg-12 mx-auto">
                   ...
                   <?php
                    ...
                    $result = mysqli_query($conn,"SELECT * FROM profile_anak where id_pendaftar = 1");
                    ?>
                    ...
                    <!-- MEMBUAT DATABASE TABLE -->
                     <label for="">INFORMASI ANAK</label>
                      <tr>
                        <td>id_pendaftar</td>
                        <td>Foto Anak</td>
                        <td>Nama Anak</td>
                    ...
                    <!-- UPDATE UPDATE -->
                        <td><a href="user_update.php?id_pendaftar=<?php echo $row["id_pendaftar"]; ?>" title='Update Record'><span><i class="bi bi-pencil"></i></span></a>
